...
- Name: app.test.ts >> Lesson 08 — Spatial continuity >> CONTINUITY toggle is visible
- Location: tests/e2e/app.test.ts:308:7
...
Locator: getByRole('checkbox', { name: /continuity toggle/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('checkbox', { name: /continuity toggle/i })
