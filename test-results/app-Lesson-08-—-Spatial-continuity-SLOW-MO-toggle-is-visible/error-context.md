...
- Name: app.test.ts >> Lesson 08 — Spatial continuity >> SLOW-MO toggle is visible
- Location: tests/e2e/app.test.ts:314:7
...
Locator: getByRole('checkbox', { name: /slow motion/i })
Expected: visible
Error: element(s) not found

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByRole('checkbox', { name: /slow motion/i })
