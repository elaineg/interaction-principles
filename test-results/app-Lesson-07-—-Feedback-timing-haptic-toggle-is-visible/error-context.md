...
- Name: app.test.ts >> Lesson 07 — Feedback timing >> haptic toggle is visible
- Location: tests/e2e/app.test.ts:294:7
...
Locator: getByRole('checkbox', { name: /haptic/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('checkbox', { name: /haptic/i })
...
- main:
  ...
  - text: ACTIVE GAIN1× ADDED LATENCY0 ms STATUSperfect 1:1
